...
<TwoColumnsVideo>
  <div slot="left" style="text-align: center;">
    ...
    <span slot="caption" style="font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">Demonstration of Finger Dexterity</span>
  </div>
  <div slot="right" style="text-align: center;">
    <Video source={tech_report3} />
    <span slot="caption" style="font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">Teleoperation via Data Glove</span>
  </div>
</TwoColumnsVideo>
...
<TwoColumnsVideo>
  <div slot="left" style="text-align: center;">
    ...
    <span slot="caption" style="font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">Grasping of Daily Objects</span>
  </div>
  <div slot="right" style="text-align: center;">
    <Video source={tech_report5} />
    <span slot="caption" style="font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">In-Hand Manipulation</span>
  </div>
</TwoColumnsVideo>

<div class="text-justify">
  ByteDexter's finger design adopts a parallel-serial kinematic structure: a 2-DoF MCP joint, 1-DoF PIP joint, and passively driven 1-DoF DIP joint replicate the kinematics of human index/middle/ring/pinky fingers. Its novel thumb design decouples the MCP joint's two DoFs, expanding the workspace and enhancing precision grasping performance.
</div>
...
<div>
    ...
    <h3 style="font-family: 'Roboto', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">
...
<div class="text-sm mt-6" style="font-family: 'Open Sans', sans-serif; color: #333; line-height: 1.4; padding: 15px; background-color: #fffff; border-left: 4px solid #007BFF; margin-bottom: 20px;">
```bibtex
@article{bytedance2025byteDexter,
  author        = "{Guangzeng Chen, Zhongren Cui, Min Du, Yang Gou, Zhigang Han,
                   Junkai Hu, Liqun Huang, Hang Li, Hao Niu, Zeyu Ren, Ruoshi Wen, 
                   Wei Xu, Haoxiang Zhang, Jiajun Zhang, Zhengming Zhu}",
