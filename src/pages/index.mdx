...
import tech_report1 from "../assets/ByteDexter-Tech-Report-1-crf.mp4";
...
<div class="text-sm mt-6 md:max-w-3xl mx-auto w-full" style="font-family: 'Source Sans 3', sans-serif; color: #333; line-height: 1.2; padding: 10px; background-color: #fffff; margin-bottom: 20px;">
```bibtex
@article{bytedance2025byteDexter,
  author       = {Guangzeng Chen and Zhongren Cui and Min Du and Yang Gou and Zhigang Han 
                  and Junkai Hu and Liqun Huang and Hang Li and Hao Niu and Zeyu Ren 
                  and Ruoshi Wen and Wei Xu and Haoxiang Zhang and Jiajun Zhang and Zhengming Zhu},
  title        = {Dexterous Teleoperation of 20-DoF ByteDexter Hand via Human Motion Retargeting},
  journal={arXiv preprint arXiv:00000},
  year={2025}
}
```
</div>