...
import hand from "../assets/hand_new-c.png";

import tech_report1 from "../assets/cover-video.mp4";
import tech_report2 from "../assets/ByteDexter-Tech-Report-2-crf-480.mp4";
import tech_report3 from "../assets/ByteDexter-Tech-Report-3-crf-480.mp4";
import tech_report4 from "../assets/ByteDexter-Tech-Report-4-crf-480.mp4";
import tech_report5 from "../assets/ByteDexter-Tech-Report-5-crf-480.mp4";
import tech_report6 from "../assets/ByteDexter-Tech-Report-6-crf-30.mp4";
import tech_report7 from "../assets/ByteDexter-Tech-Report-7-crf-30.mp4";
...
<TwoColumnsVideo>
  <div slot="left" style="text-align: center;">
    ...
    <span slot="caption" style="font-family: 'EB Garamond', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">Finger Dexterity Demonstration</span>
  </div>
  <div slot="right" style="text-align: center;">
    <Video source={tech_report3} />
    <span slot="caption" style="font-family: 'EB Garamond', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">Teleoperation via Data Glove</span>
  </div>
</TwoColumnsVideo>
...
<TwoColumnsVideo>
  <div slot="left" style="text-align: center;">
    ...
    <span slot="caption" style="font-family: 'EB Garamond', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">Grasping of Daily Objects</span>
  </div>
  <div slot="right" style="text-align: center;">
    <Video source={tech_report5} />
    <span slot="caption" style="font-family: 'EB Garamond', sans-serif; font-weight: 600; color: #333; margin-top: 12px; text-align: center; font-size: 18px; letter-spacing: 1px;">In-Hand Manipulation</span>
  </div>
</TwoColumnsVideo>
